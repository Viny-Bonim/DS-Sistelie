...
namespace DS_Sistelie.Despesas
{
    ...
    { 
        public DespesaValidator()
        {
            ...
            RuleFor(x => x.Caixa).NotEmpty().WithMessage("O campo CAIXA é de preenchimento obrigatório!\n");
            RuleFor(x => x.Funcionario).NotEmpty().WithMessage("O campo FUNCIONÁRIO é de preenchimento obrigatório!\n");
